...
#define STRING_CONFIG_H_AUTHOR "(Arpehem, E5P BTT SKR 3 EZ)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E5P BTT SKR 3 EZ"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 138.77 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -57.1, -17, -1.47 }
...
//
#define STARTUP_TUNE { 2637,120, 2637,120, 0,120, 2637,120, 0,120, 2093,120, 2637,120, 0,120, 3136,120, 0, 360, 1568,240 }
